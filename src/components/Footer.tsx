      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-slate-800 pb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="font-bold text-white text-sm">GemmaWork RDC</span>
              <p className="text-[11px] text-slate-400">Assistant IA de productivité pour la République Démocratique du Congo</p>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 text-slate-400 text-[11px]">
          <p>© {new Date().getFullYear()} GemmaWork RDC — Propulsé par Google GenAI & Gemma</p>
