...
export const ResultPanel: React.FC<ResultPanelProps> = ({
  ...
  if (isGenerating) {
    return (
      <div className="bg-white rounded-2xl border border-slate-200 p-8 sm:p-12 text-center shadow-xs min-h-[500px] flex flex-col items-center justify-center space-y-4">
        ...
        <div className="space-y-1 max-w-sm">
          <h3 className="font-bold text-slate-900 text-base">Rédaction avec Gemma...</h3>
          <p className="text-xs text-slate-500">
            Adaptation du style, de la structure et du contexte au marché congolais...
          </p>
        </div>
  ...
  if (!content || content.trim() === '') {
    return (
      <div className="bg-slate-50/80 rounded-2xl border-2 border-dashed border-slate-200 p-8 sm:p-12 text-center min-h-[500px] flex flex-col items-center justify-center space-y-4">
        ...
        <div className="max-w-md space-y-1">
          <h3 className="font-bold text-slate-800 text-base">{t.results.placeholderTitle}</h3>
  ...
  return (
    <div className="bg-slate-100 rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col min-h-[600px]">
      
      {/* Top Main Bar with Export Buttons */}
      ...
      {/* Demo Banner */}
      {isDemoMode && (
        <div className="bg-indigo-50 border-b border-indigo-100 px-4 py-2 text-xs text-indigo-900 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <Sparkles className="w-4 h-4 text-indigo-600 shrink-0" />
            <span><strong>Mode Démonstration :</strong> Document rédigé selon les normes administratives et commerciales en RDC.</span>
          </div>
        </div>
      )}
      ...
      {moduleType === 'email' && onQuickAction && (
        <div className="bg-white border-b border-slate-200 px-4 py-2 flex flex-wrap items-center gap-2 text-xs">
          <span className="font-semibold text-slate-600 mr-1 flex items-center space-x-1">
          ...
          <button
            ...
            className="px-2.5 py-1 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-lg font-medium text-slate-700 transition-colors flex items-center space-x-1 cursor-pointer"
          >
      ...
      <div className="bg-white border-b border-slate-200 p-2 sm:p-2.5 flex flex-wrap items-center gap-1 sm:gap-2 text-xs select-none">
        
        {/* Undo / Redo */}
        <div className="flex items-center space-x-0.5 border-r border-slate-200 pr-1.5">
          <button
            type="button"
        ...
        <div className="border-r border-slate-200 pr-1.5">
          <select
            ...
            className="px-2 py-1 bg-slate-50 border border-slate-200 rounded text-xs text-slate-800 font-medium focus:outline-none cursor-pointer"
          >
        ...
        <div className="flex items-center space-x-0.5 border-r border-slate-200 pr-1.5">
          <button
            ...
            title="Gras"
            className="p-1.5 hover:bg-slate-100 rounded font-bold text-slate-800 cursor-pointer"
          >
          ...
          <button
            ...
            title="Italique"
            className="p-1.5 hover:bg-slate-100 rounded italic text-slate-800 cursor-pointer"
          >
          ...
          <button
            ...
            title="Souligné"
            className="p-1.5 hover:bg-slate-100 rounded underline text-slate-800 cursor-pointer"
          >
        ...
        <div className="flex items-center space-x-1 border-r border-slate-200 pr-1.5">
          <label className="flex items-center space-x-1 p-1 hover:bg-slate-100 rounded cursor-pointer" title="Couleur du texte">
          ...
          <label className="flex items-center space-x-1 p-1 hover:bg-slate-100 rounded cursor-pointer" title="Surlignage">
        ...
        <div className="flex items-center space-x-0.5">
          <button
            ...
            className="p-1.5 hover:bg-slate-100 rounded text-slate-700 flex items-center space-x-1 cursor-pointer"
          >
      ...
      <div className="p-4 sm:p-8 overflow-x-auto flex justify-center bg-slate-200/70 min-h-[650px] flex-1">
        <div className="w-full max-w-[210mm] min-h-[297mm] bg-white border border-slate-300 shadow-xl rounded-xs p-8 sm:p-14 text-slate-900 leading-relaxed font-sans focus:outline-none relative">
          
          {/* Subtle A4 Header Watermark / Badge */}
          <div className="flex justify-between items-center border-b border-slate-100 pb-4 mb-6 text-[10px] uppercase font-bold tracking-widest text-slate-400 select-none">
            ...
            <span>GEMMAWORK RDC • ÉDITEUR A4</span>
          </div>
          ...
          <div className="border-t border-slate-100 pt-4 mt-8 text-center text-[10px] text-slate-400 select-none">
            Document généré et édité via GemmaWork RDC — Confidentiel
          </div>
      ...
      {/* Footer / Disclaimer */}
      <div className="bg-white border-t border-slate-200 p-3 sm:p-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-slate-500">
        <p className="max-w-xl text-[11px] leading-tight">
          {t.results.disclaimer}
        </p>
        <span className="text-[11px] font-semibold text-slate-400">
          Éditeur interactif A4 • Sauvegarde automatique en cours d'édition
        </span>
      </div>
